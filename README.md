...
<p>
Configure Departments. Go to Admin Panel -> Agents -> Departments. SysAdmins
</p>
...
<p>
Allow anyone to create tickets by going to Admin Panel -> Settings -> User Settings (UNCHECK: unregistered users can create tickets). Make sure to make registration required so that it requires registration and login to create tickets 
</p>
<br />
<p>
...
Configure Agents by going to Admin Panel -> Agents -> Add New. Add the names of the users 
- Jane (Dept: SysAdmins)
- John (Dept: Support)
...
Configure SLA. Go to Admin Panel -> Manage -> SLA
...
Configure Help Topics (For when users create a ticket). Go to Admin Panel -> Manage -> Help Topics.  
